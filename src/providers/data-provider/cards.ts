...
export const prototypeCards: PurposeCard[] = [
    {
      ...
      **OUTPUT FORMAT:**
      Structure as a professional investment memo with clear sections, bullet points for key metrics, and executive summary suitable for sharing with LP updates or investment committee discussions.
    ...
    },
    {
      ...
      **OUTPUT REQUIREMENTS:**
      Structure your analysis as strategic intelligence briefing suitable for executive decision-making. Include specific data points, timestamp references, and direct quotes that support your conclusions. Distinguish between short-term tactical insights and longer-term strategic implications.
