// app/api/subscriptions-proxy/[subscriptionId]/processing/route.ts
...
export async function GET(
  ...
  if (IS_DEV) console.log(`[Subscription Proxy] GET processing usage for subscription: ${subscriptionId}`);
  ...
  try {
	...
	return NextResponse.json({
	  error: "Failed to fetch processing usage data",
