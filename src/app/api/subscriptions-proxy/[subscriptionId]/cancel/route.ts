// app/api/subscriptions-proxy/[subscriptionId]/cancel/route.ts
...
export async function POST(
  ...
  if (IS_DEV) console.log(`[Subscriptions Proxy] POST cancel subscription: ${subscriptionId}`);
  ...
  try {
	...
	// Direct API call 
	const apiUrl = `${API_URL}/subscriptions/${subscriptionId}/cancel`;
