// app/api/subscriptions-proxy/plans/[id]/route.ts
...
export async function PATCH(
  ...
  if (IS_DEV) console.log(`[Subscriptions Proxy] PATCH subscription plan: ${planId}`);
  ...
  try {
	...
	// Direct API call 
	const apiUrl = `${API_URL}/subscriptions/plans/${planId}`;
...
export async function DELETE(
  ...
  if (IS_DEV) console.log(`[Subscriptions Proxy] DELETE subscription plan: ${planId}`);
